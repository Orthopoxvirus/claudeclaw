...
1. Read `claudeclaw/settings.json`.
...
3. Also list any cron jobs from `claudeclaw/jobs/` with their name and schedule.
...
2. Read `claudeclaw/settings.json`.
...
1. Read `claudeclaw/settings.json` and show the current prompt.
...
3. Read `claudeclaw/settings.json`.
...
Location: `claudeclaw/settings.json`
